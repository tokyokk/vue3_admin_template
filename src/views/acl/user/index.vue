        ...
        <template #default>
            <el-form :model="userParams" :rules="rules" ref="formRef">
                <el-form-item prop="username" label="用户姓名">
                    <el-input placeholder="请您输入用户姓名" v-model="userParams.username" />
                </el-form-item>
                <el-form-item prop="name" label="用户昵称">
                    <el-input placeholder="请您输入用户昵称" v-model="userParams.name" />
                </el-form-item>
                <el-form-item prop="password" label="用户密码" v-if="!userParams.id">
                    <el-input placeholder="请您输入用户密码" v-model="userParams.password" />
                </el-form-item>
            </el-form>
        </template>
        <template #footer>
...
const deleteSelectUser = async () => {
    ...
    // 批量删除的请求
    let result: any = await reqDeleteAllUser(idsList)
    if (result.code == 200) {
        ElMessage({
            type: 'success',
            message: '删除成功'
